...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contest.flight_date'
        db.add_column('contests_contest', 'flight_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contest.flight_date'
        db.delete_column('contests_contest', 'flight_date')
    ...
    models = {
        'contests.contest': {
            ...
            'flight_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
